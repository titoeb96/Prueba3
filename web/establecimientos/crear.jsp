            ...
            <div class="panel-body">
                        <form method="POST" action="../ServletUsuario">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="fecha_creacion" id="nombre" placeholder="Ingresar Nombre">
                            </div>
                            
                            <div class="form-group">
                                <label for="nombre">Creado_por</label>
                                <input type="text" class="form-control" name="creado_por" id="nombre" placeholder="Ingresar Nombre">
                            </div>
                            <div class="form-group">
